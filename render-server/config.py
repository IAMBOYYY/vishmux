...
CHAT_FALLBACK_DELAY_SECONDS = int(os.environ.get("CHAT_FALLBACK_DELAY_SECONDS", "18"))
CHAT_POLL_INTERVAL_SECONDS = int(os.environ.get("CHAT_POLL_INTERVAL_SECONDS", "5"))
